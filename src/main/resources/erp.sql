...
/*Table structure for table `expresssend` */

DROP TABLE IF EXISTS `expresssend`;

CREATE TABLE `expresssend` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `exp_num` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `model` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `sn` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `exp_status` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `create_name` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `create_date` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

/*Data for the table `expresssend` */

insert  into `expresssend`(`id`,`exp_num`,`model`,`sn`,`exp_status`,`create_name`,`create_date`) values (1,'111222','Ma1','as111123','寄送','admin','2019-05-20 17:44:35'),(2,'123','223','123456','已寄送','admin','2019-05-20 18:34:58'),(3,'12333344','Map','1234','已寄送','admin','2019-05-21 09:40:34'),(4,'2345','qqq','12345','已寄送','admin','2019-05-21 09:41:35'),(5,'12','123','13','已寄送','admin','2019-05-21 10:02:38');
...
insert  into `expresssort`(`id`,`exp_num`,`model`,`material_type`,`quantity`,`fault`,`type`,`remark`,`color`,`sn`,`create_name`,`create_date`,`confirm_fault`,`repair_type`,`position`) values (3,'22','33','1',NULL,'44','1','55','66','77',NULL,'2019-05-07 16:19:20','okbj','1','来料检验'),(4,'q','w','3',NULL,'e','2','r','t','y',NULL,NULL,'OK','3','入库'),(6,'12','12','2',NULL,'12','1','12','12','12222','admin','2019-05-07 17:16:03','aaa','5','入库'),(7,'123','12','1',NULL,'31','1','12','3','123','admin','2019-05-14 09:03:59',NULL,'5','分拣录入'),(8,'123','123','1',NULL,'12','1','13','2','13','admin','2019-05-14 09:04:32',NULL,'4','已寄送'),(9,'13','12','3','13','12','1','123','31',NULL,'admin','2019-05-14 09:04:46','1','2','入库'),(10,'3','4','2',NULL,'5','1','5','6','77','admin','2019-05-14 09:05:08','2','1','入库');
...
insert  into `partswarehouse`(`id`,`material_code`,`model`,`quantity`,`ichiban`,`description`,`scrap`,`remark`,`type`,`status`,`create_name`,`create_date`,`materials_status`,`receive_num`) values (1,'111','12',12,111,'12',0,'32','1','来料','name','2019-05-15',NULL,NULL),(2,'12','2155',32,0,'23',320,'34','2','来料','admin','2019-05-15 10:17:42',NULL,NULL),(6,'aa','bb',11,0,'aa',11,'asd','2','来料','admin','2019-05-15 10:23:12',NULL,NULL),(8,'12','12',1,0,'12',1,'12','2','来料','admin','2019-05-15 16:21:12',NULL,NULL),(9,'21','12',-38,70,'12',0,'12','1','来料','admin','2019-05-15 16:23:38','',''),(11,'34','11',87,87,'222',0,'445','1','来料','admin','2019-05-15 18:20:32','',''),(12,'201905171655','Ma1',1000,1000,NULL,0,NULL,'1','来料','admin','2019-05-17 16:55:30','',''),(13,'2','3',5,5,'4',0,'6','1','来料','admin','2019-05-20 10:37:10',NULL,NULL),(14,'3','4',6,6,'5',0,'7','1','来料','admin','2019-05-20 10:37:31',NULL,NULL),(15,'4','5',7,0,'6',7,'8','2','来料','admin','2019-05-20 10:37:48',NULL,NULL),(16,'5','6',8,8,'7',0,'9','1','来料','admin','2019-05-20 10:38:03',NULL,NULL),(17,'6','7',9,9,'8',0,'00','1','来料','admin','2019-05-20 10:38:21',NULL,NULL),(18,'11','2',44,44,'3',0,NULL,'1','来料','admin','2019-05-20 10:38:43',NULL,NULL),(19,'12','33',55,55,'44',0,'66','1','来料','admin','2019-05-20 10:39:02',NULL,NULL);
