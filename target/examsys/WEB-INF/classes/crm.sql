...
insert  into `jobinfo`(`id`,`job`,`departmentId`) values (1,'超级管理员',1),(2,'管理员',1),(3,'咨询师',4),(4,'咨询师主管',4),(5,'网络咨询',3),(6,'网络咨询主管',3),(7,'销售助理',5),(8,'销售员',2),(9,'销售主管',2),(10,'程序员',1);
...
insert  into `jobright`(`id`,`jobInfoId`,`rightid`) values (29,3,'1,10,11,12,13,2,3,4,5,6,7,8,9'),(31,1,'1,13,2,3,4,5,6,7,8,9'),(33,4,'2,3,4,5,6,7'),(36,2,'1');
...
insert  into `resetpass`(`id`,`username`,`phoneNo`) values (4,'assistant@oaec.com','13551269999'),(5,'admin','123'),(6,'Aocctu','123'),(7,'Aocctu','123'),(8,'admin','123'),(9,'admin','123'),(10,'admin','123'),(11,'admin','123');
