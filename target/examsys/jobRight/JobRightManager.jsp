	            ...
	            <table>
	                 <tr>
		                ...
		                <td><input class="easyui-combobox"
				            name="jobInfoid"
				            data-options="
		                    url:'${pageContext.request.contextPath}/jobRight/jobInfoDatas',
		                    valueField:'id',
		                    textField:'job',
		                    panelHeight:'auto'
		            		"></td>
	                ...
	                <tr>
	                    <td>权限功能项:</td>
	                    <td>
	                    	<ul id="add_tree" class="easyui-tree" data-options="url:'${pageContext.request.contextPath}/jobRight/treeDatas.do',animate:true,checkbox:true,cascadeCheck :false"></ul>
						</td>
	                </tr>
	            </table>
			...
			<form id="editForm" method="post">
	            <table>
	               ...
	               <tr>
	                    <td>权限功能项:</td>
	                    <td>
	                    	<ul id="edit_tree" class="easyui-tree" data-options="url:'${pageContext.request.contextPath}/jobRight/treeDatas.do',animate:true,checkbox:true,cascadeCheck :false"></ul>
						</td>
	                </tr>
