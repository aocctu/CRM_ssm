...
<head>
 ...
 <body class="easyui-layout">
 	<div class="easyui-panel" style="height:754px;padding:10px;">
		...
		<table id="dg" style="width:100%;height:400px" class="easyui-datagrid" data-options="url:'${pageContext.request.contextPath}/department/selectDatas.do',method:'post',rownumbers:true,pagination:true,border:true,singleSelect:true">
		</table>
	</div>
		...
		<div style="padding:10px 0 10px 60px">
			<form id="addForm" method="post">
	            <table>
	                <tr>
	                    <td>部门名称:</td>
	                    <td><input class="easyui-validatebox" type="text" name="dname" data-options="required:true"></input></td>
	                </tr>
	            </table>
